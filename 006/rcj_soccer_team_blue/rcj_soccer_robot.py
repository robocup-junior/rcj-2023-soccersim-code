...
class RCJSoccerRobot:
    ...
    def parse_team_msg(self, packet: str) -> dict:
        ...
        data = {
            "robot_id": unpacked[0],
            "ball_pos": [unpacked[1], unpacked[2]],
            "robot_pos": [unpacked[3], unpacked[4]],
        }
        return data
    ...
    def send_data_to_team(self, robot_id, ball_pos, robot_pos) -> None:
        ...
        """
        struct_fmt = "idddd"
        data = [robot_id] + ball_pos + robot_pos
