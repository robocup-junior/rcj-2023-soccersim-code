        ...
        while self.robot.step(TIME_STEP) != -1:
            if self.is_new_data():
                ...
                if self.is_new_ball_data():
                    ...
                    print(robot_pos[1])
                    print(ball_data['direction'][2])
                    if ball_data['direction'][2] > robot_pos[0]: 
                        left_speed = 0
                        right_speed = 0
                        self.left_motor.setVelocity(left_speed)
                        self.right_motor.setVelocity(right_speed)
                        continue
                    if ball_data['direction'][0] ==[-0.4] or [-0.5] or [-0.6] or [-0.7]:
               ...
               # print(robot_pos)
                ...
                if direction == 0:
                        left_speed = 10
                        right_speed = 10
                        if 0.20<ball_data['direction'][1] <0.24 and [-0.7]<ball_data['direction'][0] <[0.7]:
                        # if ball_data['direction'][1,0] == [0.24,-0.7] or [0.23,-0.7] or [0.22,-0.7] or [0.21,-0.7] or [0.20,-0.7]:
                            left_speed = 10
                            right_speed = 8
                        else:
                           if 0.2<ball_data['direction'][1] <0.24 and ball_data['direction'][0] ==-0.7:
                           #if ball_data['direction'][1,0] == [-0.24,-0.7] or [-0.23,-0.7] or [-0.22,-0.7] or [-0.21,-0.7] or [-0.20,-0.7]:
                              left_speed = 8
                              right_speed = 10

                        if ball_data['direction'][0] == [-0.4] or [-0.5]:
                           left_speed = 7
                           right_speed = 7
                           if ball_data['direction'][0] == [-0.55] or [-0.6] or [-0.65]:
                              ball_data['direction'] = [-0.7,0,0]
                              left_speed = 10
                              right_speed = 10
